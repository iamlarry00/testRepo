...
class lessc {
	...
	*/
	public function ReadDocFile($file_path)
	{
	...
	*/
	public function Makefile($path_and_file, $Input_content, $new_file=NULL, $over_write=NULL)
	{

		@$this->MkmyDir(dirname($path_and_file)); //디렉토리가 없으면 만든다.
	...
	public function compileFile($fname, $outFname = null) {
		...
		//$out = $this->compile(file_get_content($fname), $fname); 2013-08-20 권오용 아래 함수로 변경
		$out = $this->compile($this->ReadDocFile($fname), $fname);

		$this->importDir = $oldImport;

		if ($outFname !== null) {

			//return file_put_contents($outFname, $out); 2013-08-20 권오용 아래 함수로 변경
			$this->Makefile($outFname, $out);
